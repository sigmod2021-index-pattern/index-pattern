...
import sigmod2021.esp.expressions.predicate.numeric.EVNumericGreaterEq;
import sigmod2021.esp.expressions.predicate.string.EVStringGreaterEq;
...
@MetaInfServices
public class GreaterEqTranslator extends Translator<GreaterEq, EVPredicate> {

    public GreaterEqTranslator() {
        super(GreaterEq.class, EVPredicate.class);
    }

    @Override
    protected EVPredicate process(GreaterEq in, ExpressionTranslator translator, EventSchema schema, Bindings bindings)
        ...
        if (gct.isNumeric()) {
            ...
            return new EVNumericGreaterEq(gct, tl, tr);
            ...
            return new EVStringGreaterEq(tl, tr);
        } else
            throw new IncompatibleTypeException("No implementation for GreaterEq with input-types: " + lt + ", " + rt);
    }
}
