...
public class EVNumericLess extends EVAbstractBinaryExpression<Number, Number, Boolean> implements EVPredicate {
    ...
    public EVNumericLess(DataType type, EVNumericExpression left, EVNumericExpression right) {
