...
public class EVStringUnequal extends EVAbstractBinaryExpression<String, String, Boolean> implements EVPredicate {

    public EVStringUnequal(EVStringExpression left, EVStringExpression right) {
