...
public class EVStringLess extends EVAbstractBinaryExpression<String, String, Boolean> implements EVPredicate {

    public EVStringLess(EVStringExpression left, EVStringExpression right) {
