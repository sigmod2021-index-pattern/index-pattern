...
public class EVNumericUnequal extends EVAbstractBinaryExpression<Number, Number, Boolean> implements EVPredicate {
    ...
    public EVNumericUnequal(DataType type, EVNumericExpression left, EVNumericExpression right) {
