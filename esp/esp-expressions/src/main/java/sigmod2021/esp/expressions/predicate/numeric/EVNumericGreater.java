...
public class EVNumericGreater extends EVAbstractBinaryExpression<Number, Number, Boolean> implements EVPredicate {
    ...
    public EVNumericGreater(DataType type, EVNumericExpression left, EVNumericExpression right) {
