...
public class EVSub extends EVBinaryNumericExpression {

    static final OperatorImpl<Number, Number, Number> INT_IMPL = (Number x, Number y) -> x.intValue() - y.intValue();
    ...
    public EVSub(EVNumericExpression left, EVNumericExpression right) {
