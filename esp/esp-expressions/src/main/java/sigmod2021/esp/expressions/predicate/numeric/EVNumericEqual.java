...
public class EVNumericEqual extends EVAbstractBinaryExpression<Number, Number, Boolean> implements EVPredicate {
    ...
    public EVNumericEqual(DataType type, EVNumericExpression left, EVNumericExpression right) {
