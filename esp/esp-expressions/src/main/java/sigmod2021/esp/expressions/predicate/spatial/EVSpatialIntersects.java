...
/**
 * Tests whether the first input geometry intersects the second one.
 */
public class EVSpatialIntersects extends EVAbstractBinaryExpression<Geometry, Geometry, Boolean> implements EVPredicate {

    public EVSpatialIntersects(EVSpatialExpression left, EVSpatialExpression right) {
