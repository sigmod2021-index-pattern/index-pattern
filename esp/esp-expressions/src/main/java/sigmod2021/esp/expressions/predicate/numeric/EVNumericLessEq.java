...
public class EVNumericLessEq extends EVAbstractBinaryExpression<Number, Number, Boolean> implements EVPredicate {
    ...
    public EVNumericLessEq(DataType type, EVNumericExpression left, EVNumericExpression right) {
