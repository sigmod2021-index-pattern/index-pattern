...
public class EVStringEqual extends EVAbstractBinaryExpression<String, String, Boolean> implements EVPredicate {

    public EVStringEqual(EVStringExpression left, EVStringExpression right) {
