...
public class EVStringGreaterEq extends EVAbstractBinaryExpression<String, String, Boolean> implements EVPredicate {

    public EVStringGreaterEq(EVStringExpression left, EVStringExpression right) {
