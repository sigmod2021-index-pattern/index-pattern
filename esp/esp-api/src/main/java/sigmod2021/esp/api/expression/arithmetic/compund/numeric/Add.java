 ...
 * Computes a+b
 */
public class Add extends AbstractExpression<ArithmeticExpression> implements ArithmeticExpression {

    /**
     * @param a the first input
     * @param b the second input
     */
    public Add(ArithmeticExpression a, ArithmeticExpression b) {
        super(a, b);
    }
