 ...
 * Computes a^b
 */
public class Pow extends AbstractExpression<ArithmeticExpression> implements ArithmeticExpression {

    /**
     * @param a the first input
     * @param b the second input
     */
    public Pow(ArithmeticExpression a, ArithmeticExpression b) {
        super(a, b);
    }
